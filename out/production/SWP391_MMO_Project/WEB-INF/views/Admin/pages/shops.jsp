                                                    ...
                                                    <div class="col-12">
                                                        <form id="shopForm_${s.id}"
                                                            ...
                                                            <input type="hidden" name="action"
                                                                   id="shopAction_${s.id}" value=""/>

                                                            <label class="small text-muted mb-1"
                                                                   for="shopNote_${s.id}">
                                                                Admin note (ghi lý do khi BAN)
                                                            </label>
                                                            <textarea id="shopNote_${s.id}"
                                                                      name="admin_note"
                                                                      class="form-control"
                                                                      rows="3"
                                                                      placeholder="Lý do khóa / ghi chú quản trị...">${fn:escapeXml(s.adminNote)}</textarea>

                                                            <div id="shopNoteErr_${s.id}"
                                                            ...
                                                            <div class="d-flex align-items-center gap-2 mt-3">
                                                                <c:choose>
                                                                    <!-- Chỉ cho phép BAN nếu đang Active -->
                                                                    ...
                                                                    <c:otherwise>
                                                                        <span class="text-muted">
                                                                            Cửa hàng không ở trạng thái Active, không thể Ban.
                                                                        </span>
                                                                    </c:otherwise>
                                                                </c:choose>
...
<script>
    ...
    // Ban shop: bắt buộc admin_note + confirm 1 lần nữa
