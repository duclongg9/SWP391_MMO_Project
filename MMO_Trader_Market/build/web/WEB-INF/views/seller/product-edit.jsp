...
<main class="layout__content">
    <div class="container">
        <div class="page-header">
            <h1>Chỉnh Sửa Sản Phẩm #<%= product.getId() %></h1>
        </div>
        ...
        <div class="form-container">
            <form method="post" action="<%= request.getContextPath() %>/seller/products/edit?id=<%= product.getId() %>" class="form" id="product-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" class="form-input" required 
                               value="<%= product.getPrice() != null ? product.getPrice() : "" %>" min="0" step="1000">
                    </div>

                    <div class="form-group">
                        <label for="inventoryCount" class="form-label">Số lượng <span class="required">*</span></label>
                        <input type="number" id="inventoryCount" name="inventoryCount" class="form-input" required 
                               value="<%= product.getInventoryCount() != null ? product.getInventoryCount() : 0 %>" min="0">
                    </div>
                </div>

                <div class="form-group">
                    <label for="shortDescription" class="form-label">Mô tả ngắn</label>
                    <input type="text" id="shortDescription" name="shortDescription" class="form-input" 
                           value="<%= product.getShortDescription() != null ? product.getShortDescription() : "" %>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="primaryImageUrl" name="primaryImageUrl" class="form-input" 
                           value="<%= product.getPrimaryImageUrl() != null ? product.getPrimaryImageUrl() : "" %>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="status" name="status" class="form-input">
                        <option value="Available" <%= "Available".equals(product.getStatus()) ? "selected" : "" %>>Đang bán (Available)</option>
