...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-body">
            <form class="row g-2 align-items-end" action="${base}/admin/kycs" method="get">
                <!-- Từ khóa -->
                ...
                <div class="col-6 col-md-2">
                    ...
                    <div class="input-group">
                        ...
                        <input name="from" type="text" class="form-control" placeholder="DD-MM-YYYY"
                ...
                <div class="col-6 col-md-2">
                    ...
                    <div class="input-group">
                        ...
                        <input name="to" type="text" class="form-control" placeholder="DD-MM-YYYY"
